...
public final class DGKOperations implements CipherConstants
{
	 ...
	 * @throws HomomorphicException - If the plaintext is larger than the plaintext supported by DGK Public Key an exception will be thrown
	 */
	public static BigInteger encrypt(long plaintext, DGKPublicKey public_key) throws HomomorphicException {
		...
		if (plaintext < -1) {
			...
			throw new HomomorphicException("Encryption Invalid Parameter: the plaintext is not in Zu"
	 ...
	 * @throws HomomorphicException - If the plaintext is larger than the plaintext supported by DGK Public Key an exception will be thrown
	 */
	public static BigInteger encrypt(BigInteger plaintext, DGKPublicKey public_key) throws HomomorphicException {
	 ...
	 * @throws HomomorphicException - If the ciphertext is larger than the ciphertext supported by DGK Public Key an exception will be thrown
	 * @return plaintext
	 */
	 ...
	 * @return the encrypted sum of both DGK encrypted values
	 */
	 ...
	 * @throws HomomorphicException - If a ciphertext is negative or exceeds N, or plaintext is negative or exceeds u
	 */
	 ...
	 * @return product - the encrypted product of the ciphertext and the plaintext
	 * @throws HomomorphicException - If ciphertext is negative or exceeds N or plaintext exceeds u
	 */
	 ...
	 * @param plaintext - plaintext value
	 * @param public_key - DGK Public key the encrypted ciphertext
	 * @return product - the encrypted product of ciphertext and the plaintext value
	 * @throws HomomorphicException - If ciphertext is negative or exceeds N or plaintext exceeds u
	 */
	 ...
	 * @return sum - the encrypted sum of all encrypted values in the array
	 * @throws HomomorphicException - If an invalid input was found
	 */

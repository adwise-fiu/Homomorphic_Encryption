...
public class PaillierKeyFactory extends KeyFactorySpi 
{
	 ...
	 */
	public static PaillierKey toPaillierKey(Key key) throws InvalidKeyException 
	{
		if (key instanceof PaillierPublicKey || key instanceof PaillierPrivateKey)
		{
			return (PaillierKey) key;
		}
		else 
		{
			throw new InvalidKeyException("Not a Paillier Key!");
		}
	}
}

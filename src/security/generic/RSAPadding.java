...
// Source Code
// https://github.com/frohoff/jdk8u-jdk/blob/master/src/share/classes/sun/security/rsa/RSAPadding.java
...
public final class RSAPadding 
{
	...
	{
		return pad(PHE_Core.convert(data, ofs, len));
	}
	...
	public byte[] unpad(byte[] padded, int ofs, int len)
			throws BadPaddingException 
	{
		return unpad(PHE_Core.convert(padded, ofs, len));
	}

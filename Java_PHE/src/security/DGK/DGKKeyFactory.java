...
public class DGKKeyFactory extends KeyFactorySpi 
{
	 ...
	 */
	public static DGK_Key toDGKKey(Key key) throws InvalidKeyException 
	{
		if (key instanceof DGKPublicKey || key instanceof DGKPrivateKey)
		{
			return (DGK_Key) key;
		}
		else 
